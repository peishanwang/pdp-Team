...
public class CsvGeneratorTest {
  ...
  public void before() {
    ...
    map.put("b", "bb");
    map.put("c", "cc");
    generator1 = new CsvGenerator(Arrays.asList("a", "b"));
    generator2 = new CsvGenerator(Arrays.asList("a", "b"));
    generator3 = new CsvGenerator(Arrays.asList("a", "b", "c"));
  ...
  public void testEqualsNull() {
    Assert.assertEquals(false, generator1.equals(null));
  }
  ...
  public void testNotEqualsDiffClass() {
    ...
    Assert.assertEquals(false, generator1.equals(analyser));
  }
