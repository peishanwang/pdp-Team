...
import edu.neu.ccs.cs5010.concurrentsystem.ILiftWithRides;
import edu.neu.ccs.cs5010.concurrentsystem.LiftWithRides;
...
public class LiftWithRidesTest {
  ...
  public void testNotEqualsDiffClass() {
    ...
    Assert.assertEquals(false, liftWithRides1.equals(writer));
  }
}
